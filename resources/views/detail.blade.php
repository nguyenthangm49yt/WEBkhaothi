...
<body>
    ...
    <div id="noidungstt{{$dotthi->ma}}" class="noidungstt">
        <div style="width: 100%; overflow-x: scroll;overflow-y: scroll;border-style: solid; border-width: 1px;padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px">
            <fieldset>
                <legend><b>Thông tin Đợt thi</b></legend><br>
                <table width="100%" style="font-family: Times New Roman; font-size: 16pt" cellpading="0" cellspacing="0">
                    <tbody>
                        <tr>
                            <td width="12%" height="32">Mã Đợt thi : </td>
                            <td width="13%"> <input type="textbox" name="MaKythi" value="{{$dotthi->ma}}" style="height:28;font-size: 12pt" size="10" readonly="readonly"></td>

                            <td width="11%">Tên Đợt thi :</td>
                            <td colspan="4"> <input type="textbox" name="Tenkythi{{$dotthi->id}}" value="{{$dotthi->name}}" style="height:28;width:100%;font-size: 12pt" readonly="readonly"></td>

                        </tr>
                        <tr></tr>
                        <td height="32">Ngày thi từ : </td>
                        <td>
                            <input type="Text" name="Tungay" value="{{$dotthi->ngay_bat_dau}}" style="width: 147px; height:28;font-size: 12pt" size="25" readonly="readonly">
                        </td>
                        <td>Tới ngày : </td>
                        <td width="13%"><input type="Text" name="Toingay" value="{{$dotthi->ngay_ket_thuc}}" style="width: 147px; height:28;font-size: 12pt" size="25" readonly="readonly"></td>
                        <td width="23%">
                            Hạn đăng ký : <input type="TEXT" name="Handangky" value="{{$dotthi->han_dang_ki}}" style="width: 147px; height:28;font-size: 12pt" size="25" readonly="readonly"></td>
                        <td width="10%">Trạng thái:</td>
                        <td> <select size="1" name="Trangthaikythi" id="Trangthaikythi" disabled="" style="font-size:12pt;height:27px;width:100%">
                        ...
                        <tr>
                            ...
                            <td colspan="6"> <textarea rows="2" name="MotaKythi" style="width:100%;font-size: 12pt" readonly="readonly">{{$dotthi->mo_ta}}</textarea></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table width="100%" style="font-family: Times New Roman; font-size: 16pt">
                    <tbody>
                        ...
                        <tr height="32">
                            ...
                            <td> <input type="text" name="ngay{{$cathi->ten}}" id="ngay{{$cathi->ten}}" value="{{$cathi->ngay}}" readonly="readonly" size="8" style="text-align: center;"> </td>
                            <td><input type="text" name="gio{{$cathi->ten}}" id="gio{{$cathi->ten}}" value="{{$cathi->gio}}" readonly="readonly" style="text-align: center;font-family: Times New Roman; font-size: 12pt" size="6">
                            </td>
    ...
    <form action="{{route('dangkithi.store', ['id' => $dotthi->id]) }}" method="post">
        {{ csrf_field()}}
        <div id="ddthi" class="dd-thi">
            <div>
                <fieldset>
                    ...
                    <table class="table-detail" width="100%" border="1px" ; cellpading="0" cellspacing="0">
                        <thead>
                            <tr>
                                <th width="90px">Mã</th>
                                <th width="270px">Tên(Điểm thi/Bài thi)</th>
                                <th width="560px">Chọn ca thi</th>
                                <th width="160px">Lệ phí</th>
                                            ...
                                            <ul class='ulbaithidetail'>
                                                ...
                                                <li>
                                                    <ul class="ul-cathi">
                                                        @foreach($cathis as $cathi)
                                                        <li>
                                                            {{$cathi->ten}}<input type="radio" name="ckcathi[{{$baithi->id}}]" value="{{$cathi->id}}" disabled>
                                                        </li>
                                                        @endforeach
                                                    </ul>
                                                </li>
