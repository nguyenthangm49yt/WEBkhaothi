...
<body>
    ...
    @endif 
        ...
        {{ csrf_field()}} 
                    ...
                    <select size="1" id="HuyenTT" name="hk_huyen" style="height:27px;font-size:11pt"><option selected="" value="0">-Chọn huyện-</option><option value="10">Quận Bắc Từ Liêm</option><option value="11">Huyện Thanh Trì</option><option value="12">Huyện Gia Lâm</option><option value="13">Huyện Đông Anh</option><option value="14">Huyện Sóc Sơn</option><option value="15">Quận Hà Đông</option><option value="16">Thị xã Sơn Tây</option><option value="17">Huyện Ba Vì</option><option value="18">Huyện Phúc Thọ</option><option value="19">Huyện Thạch Thất</option><option value="20">Huyện Quốc Oai</option><option value="21">Huyện Chương Mỹ</option><option value="22">Huyện Đan Phượng</option><option value="23">Huyện Hoài Đức</option><option value="24">Huyện Thanh Oai</option><option value="25">Huyện Mỹ Đức</option><option value="26">Huyện Ứng Hòa</option><option value="27">Huyện Thường Tín</option><option value="28">Huyện Phú Xuyên</option><option value="29">Huyện Mê Linh</option><option value="30">Quận Nam Từ Liêm</option><option value="31">Khác (NN, CA,QĐ)</option><option value="01">Quận Ba Đình</option><option value="02">Quận Hoàn Kiếm</option><option value="03">Quận Hai Bà Trưng</option><option value="04">Quận Đống Đa</option><option value="05">Quận Tây Hồ</option><option value="06">Quận Cầu Giấy</option><option value="07">Quận Thanh Xuân</option><option value="08">Quận Hoàng Mai</option><option value="09">Quận Long Biên</option></select>
                       10. Ảnh hồ sơ (*.jpg, tỷ lệ 4:6)</td>
                    <td colspan="1"><input type="file" id="Anhhoso" name="avatar" accept="image/jpeg" data-type="image" onchange="ImagesFileAsURL()"></td></tr></tbody></table></fieldset></div><br><div><fieldset class="styleset">	<legend><b>B. THÔNG TIN LIÊN HỆ</b></legend><table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family: Times New Roman; font-size: 12pt"><tbody><tr><td width="19%"></td><td width="20%"></td><td width="13%"></td><td width="15%"></td>
                    <td width="23%"></td><td></td></tr><tr height="32">
                    ...
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;12. Điện thoại</td><td> Di động:  &nbsp;<input type="text" name="phonenumber_dd" value="" style="height:28;width:60%;font-size: 12pt"></td><td colspan="2"> Điện thoại Cố định (<i>nếu có</i>) : &nbsp;<input type="text" name="phonenumber_cd" value="" style="height:28;width:45%;font-size: 12pt"></td>
                    ...
                    <td><select size="1" name="uu_tien_type" style="height:27px;font-size:12pt">;<option value="0"> -Không ưu tiên- </option><option value="1">Ưu tiên 1 </option><option value="2">Ưu tiên 2 </option><option value="3">Ưu tiên 3 </option><option value="4">Ưu tiên 4 </option><option value="5">Ưu tiên 5 </option><option value="6">Ưu tiên 6 </option><option value="7">Ưu tiên 7 </option></select></td>
                    <td>  16. Khu vực</td><td><select size="1" name="uu_tien_place" style="height:27px;font-size:12pt">;<option value="0"> -Chọn khu vực- </option><option value="1">Khu vực 1 </option><option value="2">Khu vực 2  </option><option value="2NT">Khu vực 2 nông thôn </option><option value="3">Khu vực 3 </option></select> </td><td></td><td></td>
                    
                    </tr><tr height="32">
                    <td colspan="6">17. Nơi học THPT hoặc tương đương</td></tr><tr height="32">
                    <td> Năm lớp 10  -  Tỉnh/Thành phố:</td><td><select size="1" id="Tinhlop10" name="lop10_tinh" style="font-size:11pt;height:27px;" onchange="bindingHuyen('Tinhlop10','Huyenlop10','Truonglop10');"><option value="0"> -Chọn Tỉnh/Tp- </option><option value="01">Thành phố Hà Nội </option><option value="02">Thành phố Hồ Chí Minh </option><option value="03">Thành phố Hải Phòng </option><option value="04">Thành phố Đà Nẵng </option><option value="05">Tỉnh Hà Giang </option><option value="06">Tỉnh Cao Bằng </option><option value="07">Tỉnh Lai Châu </option><option value="08">Tỉnh Lào Cai </option><option value="09">Tỉnh Tuyên Quang </option><option value="10">Tỉnh Lạng Sơn </option><option value="11">Tỉnh Bắc Kạn </option><option value="12">Tỉnh Thái Nguyên </option><option value="13">Tỉnh Yên Bái </option><option value="14">Tỉnh Sơn La </option><option value="15">Tỉnh Phú Thọ </option><option value="16">Tỉnh Vĩnh Phúc </option><option value="17">Tỉnh Quảng Ninh </option><option value="18">Tỉnh Bắc Giang </option><option value="19">Tỉnh Bắc Ninh </option><option value="21">Tỉnh Hải Dương </option><option value="22">Tỉnh Hưng Yên </option><option value="23">Tỉnh Hòa Bình </option><option value="24">Tỉnh Hà Nam </option><option value="25">Tỉnh Nam Định </option><option value="26">Tỉnh Thái Bình </option><option value="27">Tỉnh Ninh Bình </option><option value="28">Tỉnh Thanh Hóa </option><option value="29">Tỉnh Nghệ An </option><option value="30">Tỉnh Hà Tĩnh </option><option value="31">Tỉnh Quảng Bình </option><option value="32">Tỉnh Quảng Trị </option><option value="33">Tỉnh Thừa Thiên -Huế </option><option value="34">Tỉnh Quảng Nam </option><option value="35">Tỉnh Quảng Ngãi </option><option value="36">Tỉnh Kon Tum </option><option value="37">Tỉnh Bình Định </option><option value="38">Tỉnh Gia Lai </option><option value="39">Tỉnh Phú Yên </option><option value="40">Tỉnh Đắk Lắk </option><option value="41">Tỉnh Khánh Hòa </option><option value="42">Tỉnh Lâm Đồng </option><option value="43">Tỉnh Bình Phước </option><option value="44">Tỉnh Bình Dương </option><option value="45">Tỉnh Ninh Thuận </option><option value="46">Tỉnh Tây Ninh </option><option value="47">Tỉnh Bình Thuận </option><option value="48">Tỉnh Đồng Nai </option><option value="49">Tỉnh Long An </option><option value="50">Tỉnh Đồng Tháp </option><option value="51">Tỉnh An Giang </option><option value="52">Tỉnh Bà Rịa-Vũng Tàu </option><option value="53">Tỉnh Tiền Giang </option><option value="54">Tỉnh Kiên Giang </option><option value="55">Thành Phố Cần Thơ </option><option value="56">Tỉnh Bến Tre </option><option value="57">Tỉnh Vĩnh Long </option><option value="58">Tỉnh Trà Vinh </option><option value="59">Tỉnh Sóc Trăng </option><option value="60">Tỉnh Bạc Liêu </option><option value="61">Tỉnh Cà Mau </option><option value="62">Tỉnh Điện Biên </option><option value="63">Tỉnh Đăk Nông </option><option value="64">Tỉnh Hậu Giang </option></select></td>
                    <td> Quận/Huyện/Thị xã:</td><td><select size="1" id="Huyenlop10" name="lop10_huyen" style="font-size:11pt;height:27px;" onchange="bindingTruong('Tinhlop10','Huyenlop10','Truonglop10')"><option value="0"> ---------- </option></select></td>
                    <td> Trường THPT: </td><td colspan="1"><select size="1" id="Truonglop10" name="lop10_truong" style="height:27px;font-size:12pt" onchange="settinhhuyentruong1112();"><option value="0"> -Chọn trường- </option></select></td>
                    </tr><tr height="32">
                    <td> Năm lớp 11  -  Tỉnh/Thành phố:</td><td><select size="1" id="Tinhlop11" name="lop11_tinh" style="font-size:11pt;height:27px;" onchange="bindingHuyen('Tinhlop11','Huyenlop11','Truonglop11');"><option value="0"> -Chọn Tỉnh/Tp- </option><option value="01">Thành phố Hà Nội </option><option value="02">Thành phố Hồ Chí Minh </option><option value="03">Thành phố Hải Phòng </option><option value="04">Thành phố Đà Nẵng </option><option value="05">Tỉnh Hà Giang </option><option value="06">Tỉnh Cao Bằng </option><option value="07">Tỉnh Lai Châu </option><option value="08">Tỉnh Lào Cai </option><option value="09">Tỉnh Tuyên Quang </option><option value="10">Tỉnh Lạng Sơn </option><option value="11">Tỉnh Bắc Kạn </option><option value="12">Tỉnh Thái Nguyên </option><option value="13">Tỉnh Yên Bái </option><option value="14">Tỉnh Sơn La </option><option value="15">Tỉnh Phú Thọ </option><option value="16">Tỉnh Vĩnh Phúc </option><option value="17">Tỉnh Quảng Ninh </option><option value="18">Tỉnh Bắc Giang </option><option value="19">Tỉnh Bắc Ninh </option><option value="21">Tỉnh Hải Dương </option><option value="22">Tỉnh Hưng Yên </option><option value="23">Tỉnh Hòa Bình </option><option value="24">Tỉnh Hà Nam </option><option value="25">Tỉnh Nam Định </option><option value="26">Tỉnh Thái Bình </option><option value="27">Tỉnh Ninh Bình </option><option value="28">Tỉnh Thanh Hóa </option><option value="29">Tỉnh Nghệ An </option><option value="30">Tỉnh Hà Tĩnh </option><option value="31">Tỉnh Quảng Bình </option><option value="32">Tỉnh Quảng Trị </option><option value="33">Tỉnh Thừa Thiên -Huế </option><option value="34">Tỉnh Quảng Nam </option><option value="35">Tỉnh Quảng Ngãi </option><option value="36">Tỉnh Kon Tum </option><option value="37">Tỉnh Bình Định </option><option value="38">Tỉnh Gia Lai </option><option value="39">Tỉnh Phú Yên </option><option value="40">Tỉnh Đắk Lắk </option><option value="41">Tỉnh Khánh Hòa </option><option value="42">Tỉnh Lâm Đồng </option><option value="43">Tỉnh Bình Phước </option><option value="44">Tỉnh Bình Dương </option><option value="45">Tỉnh Ninh Thuận </option><option value="46">Tỉnh Tây Ninh </option><option value="47">Tỉnh Bình Thuận </option><option value="48">Tỉnh Đồng Nai </option><option value="49">Tỉnh Long An </option><option value="50">Tỉnh Đồng Tháp </option><option value="51">Tỉnh An Giang </option><option value="52">Tỉnh Bà Rịa-Vũng Tàu </option><option value="53">Tỉnh Tiền Giang </option><option value="54">Tỉnh Kiên Giang </option><option value="55">Thành Phố Cần Thơ </option><option value="56">Tỉnh Bến Tre </option><option value="57">Tỉnh Vĩnh Long </option><option value="58">Tỉnh Trà Vinh </option><option value="59">Tỉnh Sóc Trăng </option><option value="60">Tỉnh Bạc Liêu </option><option value="61">Tỉnh Cà Mau </option><option value="62">Tỉnh Điện Biên </option><option value="63">Tỉnh Đăk Nông </option><option value="64">Tỉnh Hậu Giang </option></select></td>
                    <td> Quận/Huyện/Thị xã:</td><td><select size="1" id="Huyenlop11" name="lop11_huyen" style="font-size:11pt;height:27px;" onchange="bindingTruong('Tinhlop11','Huyenlop11','Truonglop11')"><option value="0"> ---------- </option></select></td>
                    <td> Trường THPT: </td><td colspan="1"><select size="1" id="Truonglop11" name="lop11_truong" style="height:27px;font-size:12pt">;<option value="0"> -Chọn trường- </option></select></td>
                    </tr><tr height="32">
                    <td> Năm lớp 12  -  Tỉnh/Thành phố:</td><td><select size="1" id="Tinhlop12" name="lop12_tinh" style="font-size:11pt;height:27px;" onchange="bindingHuyen('Tinhlop12','Huyenlop12','Truonglop12');"><option value="0"> -Chọn Tỉnh/Tp- </option><option value="01">Thành phố Hà Nội </option><option value="02">Thành phố Hồ Chí Minh </option><option value="03">Thành phố Hải Phòng </option><option value="04">Thành phố Đà Nẵng </option><option value="05">Tỉnh Hà Giang </option><option value="06">Tỉnh Cao Bằng </option><option value="07">Tỉnh Lai Châu </option><option value="08">Tỉnh Lào Cai </option><option value="09">Tỉnh Tuyên Quang </option><option value="10">Tỉnh Lạng Sơn </option><option value="11">Tỉnh Bắc Kạn </option><option value="12">Tỉnh Thái Nguyên </option><option value="13">Tỉnh Yên Bái </option><option value="14">Tỉnh Sơn La </option><option value="15">Tỉnh Phú Thọ </option><option value="16">Tỉnh Vĩnh Phúc </option><option value="17">Tỉnh Quảng Ninh </option><option value="18">Tỉnh Bắc Giang </option><option value="19">Tỉnh Bắc Ninh </option><option value="21">Tỉnh Hải Dương </option><option value="22">Tỉnh Hưng Yên </option><option value="23">Tỉnh Hòa Bình </option><option value="24">Tỉnh Hà Nam </option><option value="25">Tỉnh Nam Định </option><option value="26">Tỉnh Thái Bình </option><option value="27">Tỉnh Ninh Bình </option><option value="28">Tỉnh Thanh Hóa </option><option value="29">Tỉnh Nghệ An </option><option value="30">Tỉnh Hà Tĩnh </option><option value="31">Tỉnh Quảng Bình </option><option value="32">Tỉnh Quảng Trị </option><option value="33">Tỉnh Thừa Thiên -Huế </option><option value="34">Tỉnh Quảng Nam </option><option value="35">Tỉnh Quảng Ngãi </option><option value="36">Tỉnh Kon Tum </option><option value="37">Tỉnh Bình Định </option><option value="38">Tỉnh Gia Lai </option><option value="39">Tỉnh Phú Yên </option><option value="40">Tỉnh Đắk Lắk </option><option value="41">Tỉnh Khánh Hòa </option><option value="42">Tỉnh Lâm Đồng </option><option value="43">Tỉnh Bình Phước </option><option value="44">Tỉnh Bình Dương </option><option value="45">Tỉnh Ninh Thuận </option><option value="46">Tỉnh Tây Ninh </option><option value="47">Tỉnh Bình Thuận </option><option value="48">Tỉnh Đồng Nai </option><option value="49">Tỉnh Long An </option><option value="50">Tỉnh Đồng Tháp </option><option value="51">Tỉnh An Giang </option><option value="52">Tỉnh Bà Rịa-Vũng Tàu </option><option value="53">Tỉnh Tiền Giang </option><option value="54">Tỉnh Kiên Giang </option><option value="55">Thành Phố Cần Thơ </option><option value="56">Tỉnh Bến Tre </option><option value="57">Tỉnh Vĩnh Long </option><option value="58">Tỉnh Trà Vinh </option><option value="59">Tỉnh Sóc Trăng </option><option value="60">Tỉnh Bạc Liêu </option><option value="61">Tỉnh Cà Mau </option><option value="62">Tỉnh Điện Biên </option><option value="63">Tỉnh Đăk Nông </option><option value="64">Tỉnh Hậu Giang </option></select></td>
                    <td> Quận/Huyện/Thị xã:</td><td><select size="1" id="Huyenlop12" name="lop12_huyen" style="font-size:11pt;height:27px;" onchange="bindingTruong('Tinhlop12','Huyenlop12','Truonglop12')"><option value="0"> ---------- </option></select></td>
